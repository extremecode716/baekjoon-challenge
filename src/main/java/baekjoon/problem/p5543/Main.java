...
public class Main {
    ...
    private static void solution() {
        final List<String> inputs = Algorithm.readLines(5);

        int hamburgerMinPrice = min(Integer.parseInt(inputs.get(0)), Integer.parseInt(inputs.get(1)));
        hamburgerMinPrice = min(hamburgerMinPrice, Integer.parseInt(inputs.get(2)));
        int drinkMinPrice = min(Integer.parseInt(inputs.get(3)), Integer.parseInt(inputs.get(4)));

        System.out.println(hamburgerMinPrice + drinkMinPrice - 50);
    }
